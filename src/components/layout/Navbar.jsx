...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-light-background dark:bg-dark-background backdrop-blur-sm border-b border-light-border dark:border-dark-border shadow-sm">
