...
export default function DayCard({ day, onJournal }) {
  return (
    <div className="rounded-lg border p-4 bg-white dark:bg-zinc-900 shadow mb-4">
      ...
      {/* زر التدوين */}
      <button onClick={() => onJournal?.(day)} className="mt-2 text-xs text-amber-700 hover:underline">تدوين اليوم</button>
