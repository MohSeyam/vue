...
const templates = [
  { id: 'tpl1', title: { en: 'Meeting Notes', ar: 'ملاحظات اجتماع' }, content: { en: '', ar: '' } },
  { id: 'tpl2', title: { en: 'Learning Summary', ar: 'ملخص تعلم' }, content: { en: '', ar: '' } },
  { id: 'tpl3', title: { en: 'Daily Reflection', ar: 'تأمل يومي' }, content: { en: '', ar: '' } }
]
</script>